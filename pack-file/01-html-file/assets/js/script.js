(function ($) {
  ...
  // our-rooms
  if ($(".our-rooms__carousel").length > 0) {
    const swiper = new Swiper('.our-rooms__carousel', {
      "slidesPerView": 3,
      "spaceBetween": 0,
      "speed": 600,
      "loop": true,
  ...
  // our-rooms-two
  if ($(".our-rooms-two__carousel").length > 0) {
    const swiper = new Swiper('.our-rooms-two__carousel', {
      "slidesPerView": 3,
      "spaceBetween": 0,
      "speed": 600,
      "loop": true,
  ...
  // event-two
  if ($(".event-two__carousel").length > 0) {
    const swiper = new Swiper('.event-two__carousel', {
      "slidesPerView": 3,
      "spaceBetween": 0,
      "speed": 600,
      "loop": true,
  ...
  // Team Three Carousel
  if ($(".team-three__carousel").length > 0) {
    const swiper = new Swiper('.team-three__carousel', {
      "slidesPerView": 3,
      "spaceBetween": 0,
      "speed": 600,
      "loop": true,
